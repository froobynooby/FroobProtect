...
public class AllowFireDestroyOverrideFlag implements OverrideFlag {

    @Override
    public String name() {

        return "allow-fire-destroy-override";
    }

    @Override
    public String description() {

        return "Overrides everything to allow fire to destroy blocks.";
    }
